...
datos <- as.numeric(reviews$score)

ggplot(data.frame(score = datos), aes(x = score)) +
  geom_histogram(binwidth = 1, fill = "lightgreen", color = "black") + # Ajusta binwidth aquí
  theme_minimal() +
  theme(
  ...
  labs(title = "Histograma de Reviews", x = "Puntuación", y = "Frecuencia")
```
